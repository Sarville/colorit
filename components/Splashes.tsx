...
export const defaultSplashes: Array<SplashSpec> = [
  {src: "splash1", style: {top: "3%", left: "-9%", width: "27vw", maxWidth: 125, transform: "rotate(-14deg)"}},
  {src: "splash2", style: {top: "1%", right: "-10%", width: "29vw", maxWidth: 135, transform: "rotate(12deg)"}},
  {src: "splash7", style: {top: "38%", right: "-11%", width: "20vw", maxWidth: 95, transform: "rotate(-6deg)"}},
  {src: "splash3", style: {top: "42%", left: "-10%", width: "18vw", maxWidth: 85, transform: "rotate(10deg)"}},
  {src: "splash3", style: {bottom: "5%", left: "-11%", width: "26vw", maxWidth: 120, transform: "rotate(-18deg)"}},
  {src: "splash5", style: {bottom: "3%", right: "-9%", width: "27vw", maxWidth: 125, transform: "rotate(16deg)"}},
];
