...
export const translations = {
  ru: {
    ...
    supportButtonPrefix: "Поддержать —",
    supportFailedText: "Не получилось оформить покупку. Попробуйте ещё раз чуть позже.",
    supportFailedBalanceHint: "Если не хватает {currency} — пополните баланс и попробуйте снова.",
  ...
  en: {
    ...
    supportButtonPrefix: "Support —",
    supportFailedText: "The purchase didn't go through. Please try again in a moment.",
    supportFailedBalanceHint: "If you're short on {currency}, top up your balance and try again.",
